...
const SignInForm = () => {
    ...
    return (
        <>
            {/* Font import — add to index.html if preferred */}
            <style>{`
            ...
            <div className="font-mono-dm bg-grid min-h-screen flex items-center justify-center bg-[#0c0c0e] p-8">
                ...
                <div className="card-shine animate-fade-up relative w-full max-w-[420px] rounded-sm border border-white/[0.08] bg-white/[0.03] px-12 pb-10 pt-12">
                    ...
                    <h1 className="font-serif-display animate-fade-up mb-10 text-[2.4rem] font-normal leading-[1.1] tracking-tight text-[#f0ede6]">
                        Sign <em className="text-[#f0ede6]/50">into</em>
                        <br />
                        your account
                    </h1>
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        ...
                        {/* Password field */}
                        <div className="animate-fade-up-2 mb-0">
                            <label
                                htmlFor="password"
                                className="mb-2 block text-[0.65rem] font-medium uppercase tracking-[0.15em] text-white/35"
                            >
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="animate-fade-up-3 mt-7 w-full rounded-sm bg-[#f0ede6] py-[0.95rem] text-[0.75rem] font-medium uppercase tracking-[0.15em] text-[#0c0c0e] transition-all duration-200 hover:enabled:bg-white hover:enabled:shadow-[0_0_24px_rgba(240,237,230,0.15)] active:enabled:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50"
                        >
                    ...
                    {/* Footer */}
                    <div className="animate-fade-up-4 mt-8 border-t border-white/[0.06] pt-6 text-center text-[0.7rem] tracking-wide text-white/20">
                        No account?{" "}
                        <a
                            href="/register"
